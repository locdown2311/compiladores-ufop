...
public interface LangParserVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link LangParser#defList}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitDefList(LangParser.DefListContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link LangParser#mrets}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitMrets(LangParser.MretsContext ctx);
	/**
	 * Visit a parse tree produced by {@link LangParser#rets}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitRets(LangParser.RetsContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link LangParser#iterateCmd}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
